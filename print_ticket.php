...
<header class="header">
    ...
    if(isset($_POST['print_ticket']))
    {
        ...
        if($fetch_passanger_query_result)
        {
            ...
            $fetch_seat_query="SELECT * FROM bus_seats WHERE ticket_no='$ticket_no'";
            ...
            if($fetch_seat_query_result)
            {
                ...
                {
                    ?>
                    <div class="jumbtron container table-responsive">
                        <table class="table table table-bordered table-hover text-center table-primary">
                            <thead class="table-primary table-bordered center">
                                Passanger  details
                            </thead>
                            <tbody>
                                <tr>
