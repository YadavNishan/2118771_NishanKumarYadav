...
<header class="header">
        <nav class="navbar navbar-expand-lg navbar-light ">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="mynav">
                    ...
                    <a href="print_ticket2.php" class="btn   ps-4 pe-4" style="border-radius: 50% ;">MY TICKET</a>
                </div>
                <div class="collapse navbar-collapse" id="mynav">
    ...
    <?php
        ...
        // }
        $fetch_bus_detail_query="SELECT * FROM buses WHERE id='3'";
...
<?php
        ...
        $fetch_seat_query="SELECT bus_seat1.seat_no,bus_seat1.status,bus_seat1.bus_name FROM buses INNER JOIN bus_seat1 ON bus_seat1.bus_name=buses.bus_name ";
    ...
    if(isset($_POST['proceed_to_book_seat']))
    {
        ...
        <div class="container booking-selection">
            <form  method="post">
                ...
                <br><br>
                <p>FIRST PAY THEN CONTINUE TO BOOK YOUR SEATS     <a href="payment2.php">Pay</a> </p><br>
    ...
    if($total_choosen_seat<=$seats_available)
    {
        ...
        if($fetch_total_passanger_query_result)
        {
            ...
            if($total_no_passanger==$total_choosen_seat)
            {
                ...
                {
                    $fetch_bus_name_query="SELECT bus_name FROM buses WHERE id='3'";
                    ...
                    foreach($choosen_seat as $value){
                        $fetch_seat_status_query="SELECT status FROM bus_seat1 WHERE seat_no='$value' AND bus_name='$bus_name'";
                        ...
                        if($fetch_seat_status_query_result)
                        {
                            while($row=mysqli_fetch_assoc($fetch_seat_status_query_result))
                            {
                                ...
                                {
                                    $update_seat_query="UPDATE bus_seat1 SET status='booked' , ticket_no='$ticket_no' WHERE seat_no='$value' AND bus_name='$bus_name'";
                    ...
                    $update_seat_buses_table_query="UPDATE buses SET seats_available='$remaining_seats_buses_table' WHERE id='3'";
